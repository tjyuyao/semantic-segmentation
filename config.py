...
__C.ASSETS_PATH = '/mnt/Airdrop/CityScapes/'
...
__C.DATASET.CITYSCAPES_DIR = "/mnt/Airdrop/CityScapes/"
__C.DATASET.CITYSCAPES_CUSTOMCOARSE = \
  os.path.join(__C.ASSETS_PATH, '/mnt/Airdrop/CityScapes/refinement_final/')
